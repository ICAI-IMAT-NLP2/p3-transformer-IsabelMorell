...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, d_model: int, num_attention_heads: int, intermediate_size: int):
        ...
        self.layer_norm_3: nn.LayerNorm = nn.LayerNorm(d_model)
    ...
    def forward(
        ...
        x += self.cross_attention(hidden_state, enc_output, enc_output, mask=None)
...
class TransformerDecoder(nn.Module):
    ...
    def forward(
        ...
        tgt_mask: torch.Tensor = torch.tril(torch.ones(batch_size, seq_len, seq_len))
